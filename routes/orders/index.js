...
router.post("/create", oder.createOrder);

//http://localhost:5000/api/v1/orders
router.get("/", oder.getAllOrders);

//http://localhost:5000/api/v1/orders/:id
router.get("/:id", oder.getSingleOrder);

//http://localhost:5000/api/v1/orders/update/:id
router.put("/update/:id", oder.updateOrder);

//http://localhost:5000/api/v1/orders/update/:id
router.patch("/patch/:id", oder.updateOrder);

// http://localhost:5000/api/v1/orders/delete/:id
router.delete("/delete/:id", oder.deleteOrder);
